...
export class ProjectorApiProvider {
  ...
  getProjectors(RoomNum) {
    return this.http.get("https://crestron.sit.nyp.edu.sg/TestAPI/api/Values?RoomNum=" + RoomNum)
      .do(this.logResponse)
  ...
  InsertRoomNum(RoomNum: string, username: string) {
    ...
    //api/UsageCheckAPI?RoomNum2={RoomNum2}&CurrentUser2={CurrentUser2}&CurrentlyUsed2={CurrentlyUsed2}
